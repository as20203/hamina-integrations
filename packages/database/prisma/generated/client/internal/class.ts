...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client\"\n  output   = \"../generated/client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  // url can be provided through prisma.config.ts datasource env binding.\n}\n\nmodel HelloRecord {\n  id        Int      @id @default(autoincrement())\n  message   String\n  createdAt DateTime @default(now())\n}\n",
  "runtimeDataModel": {
    "models": {},
    "enums": {},
    "types": {}
...
config.runtimeDataModel = JSON.parse("{\"models\":{\"HelloRecord\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"message\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"}],\"dbName\":null}},\"enums\":{},\"types\":{}}")
config.parameterizationSchema = {
  strings: JSON.parse("[\"where\",\"HelloRecord.findUnique\",\"HelloRecord.findUniqueOrThrow\",\"orderBy\",\"cursor\",\"HelloRecord.findFirst\",\"HelloRecord.findFirstOrThrow\",\"HelloRecord.findMany\",\"data\",\"HelloRecord.createOne\",\"HelloRecord.createMany\",\"HelloRecord.createManyAndReturn\",\"HelloRecord.updateOne\",\"HelloRecord.updateMany\",\"HelloRecord.updateManyAndReturn\",\"create\",\"update\",\"HelloRecord.upsertOne\",\"HelloRecord.deleteOne\",\"HelloRecord.deleteMany\",\"having\",\"_count\",\"_avg\",\"_sum\",\"_min\",\"_max\",\"HelloRecord.groupBy\",\"HelloRecord.aggregate\",\"AND\",\"OR\",\"NOT\",\"id\",\"message\",\"createdAt\",\"equals\",\"in\",\"notIn\",\"lt\",\"lte\",\"gt\",\"gte\",\"not\",\"contains\",\"startsWith\",\"endsWith\",\"set\",\"increment\",\"decrement\",\"multiply\",\"divide\"]"),
...
export interface PrismaClientConstructor {
   ...
   * })
   * // Fetch zero or more HelloRecords
...
/**
  ...
  $extends: runtime.Types.Extensions.ExtendsHook<"extends", Prisma.TypeMapCb<OmitOpts>, ExtArgs, runtime.Types.Utils.Call<Prisma.TypeMapCb<OmitOpts>, {
    extArgs: ExtArgs
      ...
      /**
   * `prisma.helloRecord`: Exposes CRUD operations for the **HelloRecord** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more HelloRecords
    * const helloRecords = await prisma.helloRecord.findMany()
    * ```
    */
  get helloRecord(): Prisma.HelloRecordDelegate<ExtArgs, { omit: OmitOpts }>;
}
